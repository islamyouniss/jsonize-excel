...
```js
npm install jsonize-excel --save
```
...
```js
import readXlsxFile from 'jsonize-excel'
...
const readXlsxFile = require('jsonize-excel/node')
...
import readXlsxFile from 'jsonize-excel/web-worker'
...
// 'jsonize-excel' or 'jsonize-excel/node' or 'jsonize-excel/web-worker'.
import { readSheetNames } from 'jsonize-excel'
...
```js
import { parseExcelDate } from 'jsonize-excel'
...
```html
<script src="https://unpkg.com/jsonize-excel@0.0.1/bundle/jsonize-excel.min.js"></script>
