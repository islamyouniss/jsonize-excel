...
describe('1904', () => {
	...
	it('should parse 1904 macOS dates', async () => {
		...
		// Each field is now a plain value
		data.rows[0].date.value.toISOString().should.equal('2018-05-05T00:00:00.000Z')
		data.rows[1].date.value.toISOString().should.equal('2018-05-05T00:00:00.000Z')
		data.rows[2].date.value.toISOString().should.equal('2018-05-05T00:00:00.000Z')
		data.rows[3].date.value.toISOString().should.equal('2018-05-05T00:00:00.000Z')
		data.rows[4].date.value.toISOString().should.equal('2018-05-05T00:00:00.000Z')
	})
